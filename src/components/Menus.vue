...
.leftmove-enter-active, .leftmove-leave-active { transition: all .4s; }
.leftmove-enter, .leftmove-leave-to { transform: translateX(-90vw); }

.leftmove0-enter-active, .leftmove0-leave-active { transition: all .8s; }
.leftmove0-enter, .leftmove0-leave-to { transform: translateY(-30vw); }

.leftmove1-enter-active, .leftmove1-leave-active { transition: all 20s; }
.leftmove1-enter, .leftmove1-leave-to { transform: translateY(-40vw); }

.leftmove2-enter-active, .leftmove2-leave-active { transition: all 30s; }
.leftmove2-enter, .leftmove2-leave-to { transform: translateY(-50vw); }

.leftmove3-enter-active, .leftmove3-leave-active { transition: all 40s; }
.leftmove3-enter, .leftmove3-leave-to { transform: translateY(-60vw); }
